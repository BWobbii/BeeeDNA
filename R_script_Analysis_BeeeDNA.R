...
HY.DETpcr_FIT <-  GLM_details %>% fit(Hy.det ~ Band.1stPCR * gDNA.mass.ng + Band.1stPCR * SampleType + Band.1stPCR * Group.Sub, data = HY.DETpcr)
...
HY.MIXpcr_FIT <-  GLM_details %>% fit(N.spec ~ Band.1stPCR* gDNA.mass.ng, data = HY.MIXpcr)
...
ggsave('HY.COMP.pdf', height = 15)
ggsave('HY.COMP.jpg', height = 15)
